...
class UiHelp(UI):
    ...
    def __init__(self, window: QtWidgets.QMainWindow):
        ...
        dexterityIcon.setPixmap(self._dexterityIcon.pixmap(iconSize))
        ...
        intelligenceIcon.setPixmap(self._intelligenceIcon.pixmap(iconSize))
        ...
        strengthIcon.setPixmap(self._strengthIcon.pixmap(iconSize))
        ...
        willIcon.setPixmap(self._willIcon.pixmap(iconSize))
        ...
        wisdomIcon.setPixmap(self._wisdomIcon.pixmap(iconSize))
